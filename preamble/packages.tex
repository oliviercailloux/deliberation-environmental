...
%hidelinks
\hypersetup{breaklinks, bookmarksopen, bookmarksdepth=10}
...
\usepackage{pgf}
\usepackage{pgfplots}
	\usetikzlibrary{babel, matrix, fit, plotmarks, calc, trees, shapes.geometric, positioning, plothandlers, arrows.meta, shapes.multipart, shapes.misc}
