...
\citet{bartkowski_beyond_2018} \commentOCf{Ces [2018] incessants m’ennuient. Si on ne cite pas d’autres articles d’eux, on pourrait les laisser tomber après la (ou les) premières citations.} neither raise nor answer this question.
...
Now we rather have a formal definition, spelling out formally the basic idea that $i$'s stance can be called \emph{deliberated} once $i$ has taken into account all the relevant arguments and counterarguments. \commentOCf{Tu en fais trop. Ça va nous retomber dessus.}
