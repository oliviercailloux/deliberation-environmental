...
\commentOCf{Je mets ici certains points de R1 et R2 qui ne sont pas à propos de passages spécifiques du texte. Le reste est intégré, ou déjà résolu quand c’était mineur.}
\commentRa{How could the conditions you formulated in this article be used to inform the practical design of DMV studies?

Are there maybe examples from the empirical literature that applied desirable procedures (without knowing about your framework)? 

Does your conceptual framework imply that some of the guidelines formulated by Schaafsma et al (2018) are wrongheaded?

You switch between “aim of the deliberation” and “role of the deliberation”. In any case, I am sceptical of this particular term/phrase – it may be confused with other issues, such as discussed by Schaafsma et al. (2018) in their section on “Purpose and Chosen Theoretical Foundation”. However, your focus is different. So I’d suggest you rename this challenge/open question/issue.}
...
\commentRb{Very minor, but why is the deliberator a female and the analyst a male? Note that a couple of places the deliberator is still depicted as a man}
\commentOCf{Je crois avoir remarqué que tu préfères la stratégie \og{}he/she\fg{} à celle de l’alternance que je défends. Ce commentaire va donner de l’eau à ton moulin. Pourtant, je continue à trouver l’alternance meilleure sur le fond, il faut juste patienter pour que les reviewers s’habituent (et R2 admet que c’est very minor).}
...
\commentRb{The authors seem to equate a valid argument with an argument that trumps another. An argument may be valid even if it does not trump another argument.}
...
\commentOCf{Notre formulation me parait pourtant indiquer clairement que c’est de l’avis de $i$ qu’on parle. Faut-il encore insister sur ce point ? Je suggère d’ignorer ce commentaire.}
...
\commentOCf{Je propose de simplement remplacer \og{}in the former subsection\fg{} par \og{}in the last paragraph of section 3.1\fg{}, ou \og{}just above\fg{}. Et effectivement je ne retrouve plus pourquoi quatre.}
