...
Authors on DMV vary in the answer they give to a very basic question: should deliberation give rise to a consensus? (The citations in the next two paragraphs are taken from \citet{bartkowski_beyond_2018}.)\commentYM{je me doute que l'idée de mettre ça vient du fait que tu trouves dérangeant de mentionner trop ces gens. Mais je trouve cette idée très mauvaise, car elle donne l'impression que, dans cette partie, on ne va que répérer ce qu'ils disent, ce qui n'est pas du tout le cas}
...
\citet{cailloux_formal_2018} propose a formalization of these ideas. We present here this formalization in a very simplified form, and refer to the companion article for a more in-depth presentation and formal definitions. 
...
\commentOCf{Je suis bien d’accord. Je propose simplement de souligner que nos définitions permettent d’effectuer ce genre de test. Nos définitions permettent, ayant précisé le rôle de la délibération, de tester les protocoles de délibération eux-mêmes. Ça découle de ce qu’on dit, certes, mais on pourrait le mentionner explicitement, ça me semblerait utile pour clarifier.}
