...
\commentOC{TODO Check Roy’s position exactly.}
...
In the next section, we start by presenting a formal framework, which is a simplified version of a framework developed by \citet{cailloux_formal_2018}, and we explain how this framework allows to articulate the \emph{deliberation/decision-making} and \emph{deliberation/decision-aiding} issues more clearly and transparently. \commentOC{I have difficulties remembering which is which. I suggest something like “role of deliberation” VS “role of practitioners (in deliberation, implicitly)”.}
...
The analyst therefore actively interacts with $i$, \commentOC{I suggest to remove: “he is not a pure, neutral observer who keeps his distances with his objects study. 
He interacts with his object study ”, the rest is sufficient and not debatable. For, technically, if the object of study of the analyst is $i$’s DJ, then the analyst does not modify his object study by showing arguments.}
