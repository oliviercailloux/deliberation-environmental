...
\affil{Université Paris-Dauphine, PSL Research University, CNRS, LAMSADE, 75016 PARIS, FRANCE\\
	\href{mailto:yves.meinard@dauphine.fr}{yves.meinard@dauphine.fr}\\
	\href{mailto:olivier.cailloux@dauphine.fr}{olivier.cailloux@dauphine.fr}
}

\makeatletter
	\hypersetup{
		pdfsubject={deliberation},
		pdfkeywords={valuation, decision support, justification, empirical validation, methodology}
	}
\makeatother
...
\begin{abstract}
Une littérature importante considère les faiblesses des méthodes de préférence révélées utilisées pour évaluer les biens et services environnementaux hors marché, telles que l’évaluation contingente et les expériences de choix. L’\ac{ÉMD} a émergé en tant qu’alternative de premier plan aux versions standards de ces méthodes. Elle adjoint aux institutions délibératives des techniques d’élicitation de préférences.
Malgré un ancrage dans une litérature philosophique extensive concernant la démocracie délibérative, les fondements théoriques de l’\ac{ÉMD} restent trop peu étudiés, à l’exception notable des efforts de \citet{bartkowski_beyond_2018}, qui utilisent l’approche philosophique de Sen pour élaborer de tels fondements.
La présente contribution conceptuelle poursuit cet effort théorique en pointant deux aspects laissés ouverts par la contribution mentionnée ci-dessus. Le premier est le rôle précis que la délibération est supposée jouer dans l’\ac{ÉMD} et plus généralement dans l’aide à la décision (nous appelons cet aspect le \emph{certificat de la délibération}) ; le second est le rôle que les économistes et consultants impliqués dans le déroulement de la délibération sont supposés jouer (un aspect que nous nommons le \emph{rôle de l’analyste}).
Afin de clarifier la sorte d’investigations que l’\ac{ÉMD} ou une quelconque méthode alternative, devrait implémenter pour lever toute ambiguïté sur ces aspects, nous utilisons un cadre formel introduit par \citet{cailloux_formal_2019}, conçu pour capturer la posture adoptée par un individu sur un sujet donné après avoir participé à une délibération : son \emph{jugement délibéré}.
Ce cadre permet d’identifier les questions empiriques auxquelles l’\ac{ÉMD} ne répond pas alors que de telles réponses seraient nécessaires à la clarification du positionnement de l’\ac{ÉMD} sur l’aspect du \emph{certificat de la délibération}.
Quand au \emph{rôle de l’analyste}, notre cadre plaide en faveur de confier à l’analyste le rôle actif de création de ce que nous appelons des modèles de jugement délibéré.
Ce cadre aide à charactériser les positions normatives adoptées lors de l’implémentation d’une approche délibérative.

\textbf{Mots clés} : évaluation, aide à la décision, justification, validation empirique, méthodologie.
\end{abstract}
...
\ac{DMV} has emerged as a prominent alternative to the standard versions of these methods. It combines deliberative institutions with preference elicitation. 
Despite an anchorage in an extensive philosophical literature on deliberative democracy, the theoretical foundations of \ac{DMV} are underinvestigated.  
...
The first issue is the precise role that deliberation is expected to play in \ac{DMV} and, more broadly, in decision-making (we term this the \emph{deliberative credentials} issue); 
...
In order to clarify the kind of investigations that \ac{DMV} or any alternative method should implement to be unequivocal on these issues, we use a formal framework introduced by \citet{cailloux_formal_2019}, designed to capture the stance that an individual has on a given topic once she has participated in a deliberation: her “deliberated judgment”. 
This framework allows to identify empirical questions that \ac{DMV} do not tackle whereas answering these questions would be necessary to clarify the stance that \ac{DMV} takes on the \emph{deliberative credential} issue. 
...
\textbf{Keywords}: valuation, decision support, justification, empirical validation, methodology.

\textbf{JEL Classification}: B41, D60, C9, D83.
\end{abstract}
\acresetall
...
A prominent alternative to standard \ac{SPM} has emerged in the past 25 years, with first applications in the 2000s: \ac{DMV} \citep{spash_deliberative_2007,bartkowski_economic_2017}. 
...
At a philosophical level, the very label of these methods, and the deliberative institutions on which they are based, refer to the notion of deliberative democracy, which has been extensively investigated since the 1980s and is now prominent in the literature in political philosophy \citep{chappell_deliberative_2012}.
...
In this section, we present the formal framework proposed by \citet{cailloux_formal_2019} and explain the methodology used to devise and use such a formal framework, and show how this approach addresses the the \emph{deliberative credentials} and the \emph{role of the analyst} issues.
...
%Notice also that our approach can accommodate both substantive and normative understandings of the aim of deliberation. In the substantive view, rational and anti-paternalistic preferences are good in themselves. 
%\commentOCf{Le reviewer comprend plutôt la position \og{}substantive\fg{} comme affirmant que donner des informations factuelles et prendre en compte les biais cognitifs amène à une position plus rationnelle. C’est totalement différent de notre définition, qui parle de la raison pour laquelle la délibération dans notre sens serait appréciable. Ça me parait raisonnable de penser que au moins certains auteurs, et peut-être une majorité, utilisent le terme \og{}substantive\fg{} comme le comprend le reviewer plutôt que comme nous le définissons : dans le sens où nous le définissons ici, le terme ne semble pas décrire quoi que ce soit de substantif, mais être plutôt normatif. Si le reviewer a raison que beaucoup d’auteurs utilisent le terme comme il pense, il me semble qu’il faut ajuster notre formulation, peut-être en évitant le terme \og{}substantive\fg{}.} 
%In the normative view, helping people to form rational and anti-paternalistic preference is a democratic endeavour (that being said, we do not claim that our approach will necessarily sound perfect to all the defenders of either substantive or normative views; in particular, some might be unsatisfied with our characterization of the point of discussions, spelled out above.
%\commentOCf{Cette parenthèse (même si elle était fermée) me semble très insatisfaisante : on affirme une chose puis on écrit simplement que certains ne seront pas d’accord avec nous et peuvent être insatisfaits, sans dire pourquoi ou ce qu’on leur répondrait. C’est un peu facile ! Je propose plutôt de dire que notre approche peut accomoder \og{}some\fg{} normative understandings of the aim of deliberation, in so far as helping people to form rational and anti-paternalistic preference would be considered as a democratic endeavour that is good in itself. Ou qqch. comme ça. À ajuster en fonction de ce qu’on décide pour ce qui concerne le terme \og{}substantive\fg{}. En fonction de quoi il faudra peut-être ajuster notre réponse au reviewer, mais peut-être pas car ta réponse est sans-doute suffisament générale.}
...
A model of someone’s \ac{DJ} (given a topic and a set of arguments) is defined as a series of hypotheses concerning the propositions that are in her \ac{DJ} and the arguments that support these propositions in her view, together with an argumentative strategy, i.e. hypotheses concerning counter-arguments and means to counter them, phrased in terms of predictions about the \ac{DM}’s declarations about which arguments trump which arguments.% 
\footnote{Elaborating such models is bound to be a complex task, involving important theoretical and practical challenges. Let us leave aside these issues to focus on the meaning of the process.} 
The goal of a model is to capture the individual’s \ac{DJ}. Such a model can hence be said to be \emph{valid} if the \ac{DM}’s \acp{DJ} are indeed the ones hypothesized by the model.
...
Habermas’s theory hence appears to be plagued by the same problem that he denounced in Rawls’s theory: both wanted to prove that consensus will occur on certain issues, but none of them achieved to do it without surreptitiously taking a questionable stance on the role of the analyst issue. 
...
%For example, one could study the \ac{DJ} of individuals concerning which sorts of arguments they think they should be indifferent to when considering a given topic; and observe whether indeed their \ac{DJ} about that topic is not influenced by those sorts of arguments.
%Indeed, if it turns out (empirically) that people’s propensity to take arguments into account is deeply and irredeemably determined by brute psychological facts that are beyond the reach of our protocol, then the rationality requirement loses much of its normative force.
%\commentOCf{La version précédente de la précision me semble sauter trop vite à la conclusion. Il n’est pas évident de déterminer ce qui nuirait fortement à la normativité de la rationalité telle qu’on la définit, car cette exigence me semble très fondamentale. J’ai essayé de donner un autre exemple en évitant de prendre position.}
...
The precise definition of \acp{DJ}, together with the procedure outlined in the framework above, provide the building blocks to develop the studies needed to address the empirical questions pinpointed just above, which are key to a rigorous application of \ac{DMV} but are currently neglected in the literature.
