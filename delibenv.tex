...
\commentYM{Franchement, je trouve ces histoires de protocole et de contexte absolument incompréhensibles. Moi même, qui ai pourtant suivi le projet d'assez près, j'ai suis complètement dans le flou... alors un lecteur innoccent, je vois mal comment on pourrait attendre de lui qu'il comprenne. Et ne parlons pas des lectrices. Je mets en gras les choses qui me paraissent complètement incompréhensibles, et je fais une tentative pour avoir quelque chose de plus abordable}
...
\commentOCf{Je pense que ça va vraisemblablement turner out to be the case, mais que je trouve que ça ne raise probablement pas de doubts insurmontables on the normative force of the stuff. Pour éviter d’insister sur ce point, je propose de remplacer les deux dernières phrases par la suivante. This empirical question has major bearings for conceptual investigations on the normative significance of requirements such as the one of rationality, as we have defined it in this article.}
