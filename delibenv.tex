...
\commentRb{
	...
	\item Page 5: The authors seem to equate a valid argument with an argument that trumps another. An argument may be valid even if it does not trump another argument.
	...
	\item Page 7: Very minor, but why is the deliberator a female and the analyst a male? Note that a couple of places the deliberator is still depicted as a man
...
It may be that this observation made the authors to turn to the procedure issue on the next page. As already mentioned, it comes in as unmotivated, but seems to be a critical issue regarding the quality of the deliberative process and how to judge that quality, albeit being based on very different arguments compared to those mainly advocated in the paper.
	...
	\item Page 10: in the headline of 3.2, the authors refer to four empirical challenges. I could not find a way to identify that there were four.
	\item Page 12: The reference O. Cailloux and Y. Meinard. A formal framework for deliberated judgment is published in 2019 and the reference should be to that publication
	\end{itemize}
}
