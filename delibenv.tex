...
\commentYM{dire dès l'intro qu'il n'y a pas d'implications concrètes}

\commentOCf{Je laisse ici les commentaires dont je ne suis pas sûr qu’ils soient caduques. Ils sont liés à des discussions encore ouvertes (je pense) dans le reste du texte. Je propose de se concentrer sur les commentaires plus loin dans le texte et revenir à ceux-ci dans un deuxième temps, quand on aura convergé sur les autres discussions.}
...
The scope of the \emph{deliberative credentials} and the \emph{role of the analyst} issues is clearly larger than \ac{DMV}, and even larger than \emph{environmental} issues. 
...
In the present article, we pursue this dynamic, while emphasizing that our arguments could be adapted to other contexts. In section 2, we take advantage of a formal framework introduced by \citet{cailloux_formal_2019} to clarify the challenges raised by these two issues.
...
\commentOCf{Magnifique. Mais à la réflexion, c’est peut-être aller trop loin. Le DJ de qqn dépendra des circonstances dans lesquelles il a été exposé aux arguments. En présence d’autres personnes, qqn pourrait affaiblir son opinion, en voyant que d’autres ne jugent pas de la même façon. Ce qui facilite le concensus, et pas nécessairement par un effet non désirable de domination par ceux qui parlent plus fort. C’est une des intuitions fortes de la délibération en tant que discussion, et elle semble pertinente. Ne devrait-on pas le prendre en compte dans notre conception du rôle de la délibération ? Il semble qu’il y ait en fait deux objectifs à discuter : 1) éliciter une forme de DJ ; 2) éliciter le bon DJ, celui qui s’exprime quand on est dans les circonstances où on est ouvert d’esprit. Le 2) est une précision de 1). La discussion permet peut-être 2). On pourrait dire qu’on ne prend pas position sur quel DJ précisément doit être élicité (les circonstances), mais qu’il faut au moins 1). Mais alors, on ne fait peut-être qu’une partie du chemin qu’on annonce qu’on va faire en parlant du rôle de la délibération.}\commentYM{je ne comprends pas ce commentaire. Je ne saisis pas de quelles "intuitions fortes de la délibération tu parles. Je ne comprends pas non plus ce que tu dis sur les circonstances, et les bons et mauvais DJ}
...
\commentOCf{On pourrait dire qqpart en introduction que notre proposition est une voie de recherche et non une méthodologie prête à l’emploi. On indique déjà en conclusion qu’on n’a pas dit comment précisément obtenir les modèles nécessaires. On pourrait peut-être aussi formuler des pistes en vue d’amener à des recommandations pratiques (ce qui ne me parait pas simple, ceci dit), ou simplement réitérer que nous nous bornons à une clarification conceptuelle des objectifs et pensons que cela peut permettre à d’autres travaux d’avancer sur la pratique. Ceci dit, la conclusion actuelle me semble convenir, à première vue. À re-réfléchir ultérieurement ?}\commentYM{à la réflexion je trouve que dans ce papier on est très clairs sur le fait qu'on ne fournit pas une boîte à outils clefs en mains. On ne va quand même pas le répéter à chaque paragraphe}
...
\commentOCf{Je ne comprends pas bien ce qu’on dit dans le § suivant, entre autres parce que je ne sais pas précisément quel est “this problem”}. \commentYM{je ne comprends pas le souci. "This problem" est formulé juste au-dessus : le problème c'est qu'aussi bien Habermas que Rawls AFFIRMENT qu'il y aura consensus, sur des bases purement conceptuelles dans les deux cas. Notre approche offre une autre solution : nous ne cherchons pas à montrer conceptuellement qu'il y aura consensus, nous offrons la perspective de regarder empiriquement s'il y a consensus ou pas. Je ne vois pas bien en quoi ceci, qui est dit dans les 2 derniers § de cette sous-section, est différent de ce que tu as mis en italique. Si tu préfères ta formulation, je n'y vois aucun inconvénient} \commentOCf{J’ai l’impression que plusieurs problèmes a priori distincts (ou aux relations non limpides) sont abordés dans le § précédent et qu’il faut les lier. Il y a la question de la dimension interpersonnelle, qui semble se référer à la question du consensus, mais qui concerne peut-être autre chose. Il y a la question du we-rationality, qui me semble potentiellement assez distincte. Il y a la question de faire remarquer que le DJ peut s’appliquer non seulement à l’issue terre à terre mais aussi à des problèmes d’ordre supérieurs, tels que le moyen d’aggréger les opinions de gens en désaccord. Il y a l’observation qu’on ne peut pas simplement aggréger additivement sans justification, mais faire cette observation sans proposer autre chose, n’est-ce pas s’attirer des ennuis ? Bref, je suis un peu perdu sur notre objectif ici, et je me demande si on ne se tire pas une balle dans le pied en soulevant des problèmes que, pour certains, on ne semble pas résoudre. Je proposerais de se focaliser sur un seul aspect : notre proposition peut permettre dans certains cas d’atteindre un consensus, dans les cas où le DJ sur l’issue sera consensel, ou un DJ d’ordre supérieur (sur la façon de régler les désaccords) consensuel peut être trouvé. 
Voici, en italique, un premier jet de proposition pour te donner une idée de ce que j’ai en tête (qui remplacerait le § suivant et le dernier §). 
Reste toutefois le problème que je me sens obligé de préciser qu’on ne prétend pas vraiment résoudre ce problème compliqué en un §, et que du coup, le risque de se tirer une balle dans le pied est toujours présent. Je soupçonne qu’on peut l’amoindrir avec une formulation plus prudente. À réfléchir et discuter.}

\emph{Our approach turns the question of existence of a consensus into an empirical one. Consensus is achievable, without taking a questionable stance on the role of the analyst issue, in the situations where a consensual \ac{DJ} can be obtained by all individuals in the society on a specific issue, or, a consensual \ac{DJ} can be obtained on the higher-order issue of the procedure used to resolve lower-orders disagreements. \commentOCf{On pourrait préciser ici au passage que ça permet d’éviter d’appliquer une procédure d’aggrégation choisie arbitrairement telle que l’addition des WTP, si tu tiens à tackler nos amis, mais il faut être prudent pour éviter les remarques du type le WTP est additif par définition.} We defer to other studies the difficult question of applying our proposal systematically to the study of social decision making, rather than individual decision making. Furthermore, similarly to most philosophers and analysts, we do not claim, of course, that consensus can be achieved on all matters, and our proposal is no magical means to solve every disagreement in the world.}
...
\subsection{Four empirical challenges for the future of \ac{DMV}}
...
\commentYM{autre challenge empirique : quid des circonstances. Cf implications sur la force normative de la proposition, et de la littérature sur la délibération en général
Aussi : différence entre notre protocole et PRENDRE EN COMPTE LES ARGUMENTS}
