...
\commentOCf{Voir remarque dans le texte.}
...
\commentOCf{Cet aspect, la question de l’agrégation en cas de désaccord, me semble être un troisième aspect de cet article, différent de la question du rôle de la délibération (obtenir les DJs individuels) et du rôle de l’analyste. Si on veut l’investiguer, il gagnerait à être présenté comme un troisième aspect dès le départ, en plus des deux autres. Mais veut-on vraiment l’investiguer ?}\commentYM{je ne comprends pas ce que tu dis. Ici, je ne parle pas seulement d'agrégation en cas de désaccord. Ce que je dis c'est qu'une approche délibérative comme celle de B et L ne sait pas où elle va : elle n'a pas de critère pour savoir si elle a atteint ce qu'elle veut, à la différence d'une approche qui vise le consensus (pour elle, s'il n'y a pas consensus, c'est sûr que c'est râté), et à la différence du cadre deliberated judgments, qui définit le jugement délibéré. Je me rends compte du coup que j'ai insisté trop sur l'agrégation, qui est accessoire dans l'argument. J'ai simplifié} \commentOC{Ça me semble être une question compliquée. Certes, l’intuition qu’on peut tenter d’obtenir l’avis des participants aussi sur la procédure d’agrégation (si j’ai bien compris ce que tu suggères) est intéressante et à explorer, mais elle ouvre un grand nombre de questions et on n’en dit pas assez, il me semble, pour pouvoir prétendre qu’on ouvre une nouvelle approche raisonnablement bien ficellée pour résoudre ce problème. On balance cette intuition brute et on se casse…}
...
\commentOCf{Je ne te trouve pas assez gentil dans la phrase suivante. Je dirais plutôt quelque chose comme suit. They advocate the use of additive aggregation of individual WTP, ``for lack of better alternatives'', but a satisfactory solution to this aspect is still to be found.}\commentYM{je ne comprends pas à quoi fait référence ton ``this aspect''} \commentOC{If we want to delve into this aspect, I suppose we have also to briefly state reasons against this approach.}\commentYM{bof, je pense que le lectorat de la revue a des idées en la matière... mais oui pourquoi pas}
However, \citeauthor{bartkowski_beyond_2018} do not properly discuss the aggregation issue (as illustrated, for example, by their reference to ``the question whether WTP elicitation is the right way to aggregate individual preferences'', which confuses elicitation and aggregation, and leads to a discussion of the former in their paragraph 4.5 supposedly devoted to the latter). 
They advocate the use of additive aggregation of individual WTP, ``for lack of better alternatives'', but do not investigate if and how using this aggregation rule could possibly solve the problem (a possible line of argument, which they do not develop, could be to argue that disagreeing people could all agree that their disagreements should be solved thanks to an additive aggregation; but this argument would simply beg the question).\commentYM{je propose de ne garder que cette parenthèse en lieu et place de tout le blabla sur l'aggrégation}
...
%This sentence points a contrast that the rest of the article ignores, between two levels at which a consensus might exist or fail to exist: on the one hand, \commentOC{If we keep this, I’d like to use a word more specific for first-level-preferences, because also the other level (aggregation) involves preferences: preferences over aggregation procedures. Consider citing my work with Endriss.}\commentYM{perfect, insère ton vocable et ta référence} the level of preferences, on the other hand, the level of the decision to be collectively made on the issue at hand. 
%Indeed, in the rest of their reasoning, \citeauthor{bartkowski_beyond_2018} talk about possible disagreements at the level of individual preferences but, apart from stating that ``CBA  does not replace a political decision-making process, it can only inform such a process'', they do not investigate the question of what to do with possible disagreements once preferences are elicited.  
...
In the next section, we start by presenting a formal framework, which is a simplified version of a framework developed by \citet{cailloux_formal_2018}, and we explain how this framework allows to articulate the \emph{deliberation/decision-making} and \emph{deliberation/decision-aiding} issues more clearly and transparently. \commentOC{I have difficulties remembering which is which. I suggest something like “role of deliberation” VS “role of practitioners” (meaning, implicitly, role of practitioners in deliberation).}\commentYM{bof... si t'y tiens... moi j'aurai du mal à me rappeler lequel est lequel!}
...
\commentOC{I add a part of sentence to the next sentence, because I want to make clear that when presenting our FW, we have a precise notion of “deliberation” in mind, which might differ from what some writer in the literature in “deliberation” have in mind. I think it is adequate to insist even though you stated it already. We do not claim that our FW captures what some writer in the literature has in mind, we simply claim that it captures something specific, which may or may not correspond to the usual outputs of usual procedures of deliberation as currently defined in the literature (this is where the empirical question appears). We must make sure, right from the start, that the reader does not mix up those two senses of deliberation.}
...
\commentOC{In our view the actor does not have to be able to argue by herself, which is an important difference. The first idea, as the above § explains, says that it is enough, to be rational, to carefully consider arguments and counter-arguments. Demanding an ability to counter-argue or explain one’s position is much more demanding. (And way too demanding, IMHO.)}\commentYM{je ne comprends pas : tu préconises quelle modification ici ?}
...
\commentOCf{J’avais oublié qu’il faut éviter le terme de vérité avec les philosophes, ça les rend nerveux. Mais j’insiste. On pourrait peut-être appeler cette deuxième idée “autonomy”, ou “subjectivism”. \og{}Anti-paternalisme\fg{} n’est pas une bonne caractérisation de cette deuxième idée, car elle s’oppose, certes, à l’infantilisation qui a lieu en cas d’approche paternaliste, mais aussi à des cas où il ne conviendrait pas de parler de paternalisme. 

Pour prouver ma thèse, je dois exhiber un exemple d’approche à laquelle cette deuxième idée s’oppose, mais qui ne met pas en œuvre de paternalisme. En voici un. Considérons une personne riche qui engage une agence de communication pour faire croire que baisser les impôts, c’est bien. La personne ne croit pas, et ne prétend pas, que ce soit bien pour son audience, elle agit par pur intérêt personnel. Je ne trouve pas son attitude paternaliste, car parler de paternalisme requiert de déclarer vouloir protéger autrui. Or, elle est bien opposée à notre deuxième idée. 

En voici un autre.
Considérons un expert en Machin (une discipline scientifique prestigieuse) qui veut faire gagner du temps et est sûr que chacun serait d’accord, s’il pouvait comprendre, avec ses thèses (bien étudiées et débattues dans la littérature technique, mais difficiles d’accès pour le néophyte). L’expert en question pense donc qu’il n’est pas la peine de demander à qui que ce soit son opinion sur le sujet. Je trouve que le traiter de paternaliste serait inadéquat. Or, son attitude est bien opposée à notre deuxième idée. 

Par ailleurs, je trouve le terme anti-paternaliste inadéquat pour une deuxième raison, liée à la première : \href{http://www.cnrtl.fr/lexicographie/paternalisme}{paternalisme} est un terme péjoratif, car associé à l’imposition d’une domination. Des gens qui penseraient qu’une attitude opposée à notre deuxième idée est parfois adéquate, et qui penseraient qu’une telle attitude n’entraine pas nécessairement d’imposition d’une domination, pourraient se sentir attaqués par un tel terme. Il risque de remplacer le débat par l’insulte, en traitant automatiquement les adversaires de notre deuxième idée de paternalistes. Autrement dit, le terme présente notre position d’une façon injustement avantageuse et n’incite pas au débat serein. (Bien sûr, j’admets que le problème est aussi présent pour le terme de rationalité, mais je conçois plus difficilement qu’on s’y oppose, à moins d’être prêt à assumer une certaine forme d’anti-rationalisme ; tandis qu’une personne qui s’opposerait à notre deuxième idée pourrait n’être pas enchantée de se faire traiter de paternaliste.)}\commentYM{tout ça pour UN mot! Et c'est moi le philosophe! Bref, soit, si tu ne veux pas de ``parternalisme'', dégageons-le... Mais pour le remplacer par quoi ? ``Subjectivism'' est clairement exclu : quelle crédibilité aurait-on en disant que notre vision de la rationalité est subjectiviste ?! `''Autonomy'', pourquoi pas... c'est un bâton pour se faire battre, mais on aime ça !}
...
\commentOCf{Je voudrais tenter une autre stratégie. Je minimise le rôle des perspectives et j’essaie d’éviter les détails inutiles. Tu me diras ce que tu en penses.}
...
%We assume for simplicity that the part of $i$’s stance captured by $\ileadsto$ does not evolve over time.
...
\commentOC{I was going to change acceptable to justifiable to reflect our new vocabulary, but the link with Rawls is then lost, and the reader will wonder why we didn’t chose the term “acceptable”. Should we stick to a unified vocabulary accross all articles? Or could we use “acceptable” here for this audience, using the fact that confusions with the vocabulary of FAT is less likely (depending on where we intend to submit this)?} \commentYM{je pense qu'en effet on peut adapter le vocabulaire à l'audience.}
...
The credibility of this interpretation is reinforced by the fact that \citeauthor{rawls_political_2005}’s \citeyearpar{rawls_political_2005} later work grants an increasing importance to the notion of “due reflection” --- a notion that does not refer to principles and is more general than the one of “reflective equilibrium”. \commentOCf{Je trouve qu’il serait bon de citer au passage Sen, l’idée de justice (trouver où), qui m’a influencé, entre autres pour son accent mis sur le Spectateur Impartial de Smith (également cité dans BL).}\commentYM{j'ai toujours du mal à citer Sen parce que pour moi c'est de la merde. Par ailleurs, les relations entre la théorie de l'observateur impartial et la théorie de Rawls (et, a fortiori, les théories délibératives, me semblent trop compliquées pour être traitées en 1 phrase. J'ai peur que ça finisse en référence beauf qui ne veut rien dire}

\commentOCf{À mon avis, ce § ne sert à rien et est légèrement nuisible. On stress, dans notre texte, on stress. Inutile de dire qu’on stress en plus, c’est lourd et ça peut susciter des querelles de chapelle.} \commentYM{soit} %Although we obviously agree with \citeauthor{bartkowski_beyond_2018} that Sen's philosophy provides important insights into the theoretical foundations of DMV, by displaying this anchorage of our formal framework in the search for an articulation between the requirements of rationality and anti-paternalism (and its examplification by Rawls's notion of a “reflective equilibrium”), we hence want to stress that the larger literature in political philosophy also contains useful sources that are liable to help structuring the foundations of DMV.
...
\commentOC{Should we also say that we acknowledge that our proposition does not go as far as providing a concrete protocol for DMV? How do we go from a set of individual’s DJ (even assuming we would be able to obtain that) to a collective valuation? There’s many more questions to solve. And we left aside the question of second-order preferences (preferences over preferences).}\commentYM{je préfèrerais éviter de parler de second-order preferences puisqu'on a coupé sur l'agrégation. Je te laisse rédiger ta surenchaire de modestie}
