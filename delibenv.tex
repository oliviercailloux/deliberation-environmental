...
\commentOCf{Faut-il indiquer dans le texte que nous concevons cet article comme un commentaire en réponse à un article spécifique ?}
...
\commentOCf{J’hésite concernant cette formulation. Pourrait-on être critiqués pour ambition insuffisante ? Il me semble qu’on fait plus que souligner l’importance : on propose une piste pour répondre aux questions. D’un autre côté, on ne peut certainement pas dire qu’on résoud vraiment le problème. Donc peut-être que cette annonce modeste nous évitera des critiques. Je te laisse juge.}
