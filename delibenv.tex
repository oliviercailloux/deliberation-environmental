...
In the next section, we start by presenting a formal framework, which is a simplified version of a framework developed by \citet{cailloux_formal_2018}, and we explain how this framework allows to articulate the \emph{deliberation/decision-making} and \emph{deliberation/decision-aiding} issues more clearly and transparently. \commentOC{I have difficulties remembering which is which. I suggest something like “role of deliberation” VS “role of practitioners” (meaning, implicitly, role of practitioners in deliberation).}
